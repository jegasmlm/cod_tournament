...
function PlayerItem({player, horizontal, size, className, onClick, props}) {
  return (
    <div className={className + (horizontal ? ' h-layout align-center' : ' v-layout')} key={player.id} onClick={onClick} {...props}>
